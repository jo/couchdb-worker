...
function AttachmentsWorker(config, db) {
  ...
  function checkAttachment(doc, name) {
    ...
    return check.call(this, doc, name);
  }
  ...
  config.processor = {
    check: function(doc) {
      ...
      return doc._attachments &&
        ...
        _.any(_.keys(doc._attachments), function(attachment) { return checkAttachment.call(this, doc, attachment) }, this);
    },
    process: function(doc, commit) {
      // get next attachment to be processed
      var attachment = _.find(_.keys(doc._attachments), function(attachment) { return checkAttachment.call(this, doc, attachment) }, this);

      this._log('process attachment ' + attachment);

      process.call(this, doc, attachment, function(error, attributes) {
        var status = {};
        ...
        commit(error, attributes, status);
      });
    }
  };
