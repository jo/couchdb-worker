...
module.exports = CouchDBWorker;

function CouchDBWorker(config) {
...
CouchDBWorker.prototype._on_all_dbs = function(error, resp, data) {
...
CouchDBWorker.prototype._listen = function(db) {
  this.workers.push(new Worker(this.config, db));
};

// check response and log errors
CouchDBWorker.prototype._checkResponse = function(error, resp, data, msg) {
  if (error !== null) {
